...
public final class ece_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<h1>ELECTRONICS & COMMUNICATION</h1>\n");
      out.write("</div>\n");
      out.write("<!--/.content-->\n");
...
ResultSet rs = st.executeQuery("select * from faculty where department='ELECTRONICS & COMMUNICATION'");
while(rs.next())
{
