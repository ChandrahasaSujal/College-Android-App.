                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <tr style="height: 50px"><td>Subject</td><td><input type='text' name='subject' id='subject'>
                                 <tr style="height: 50px"><td>Subject Type</td><td><select name='subject_type' id='subject_type'>
