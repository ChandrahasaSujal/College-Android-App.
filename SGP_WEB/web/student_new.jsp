                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <tr style="height: 50px"><td>Student Name</td><td><input type='text' name='name' id='name'>
                                 <tr style="height: 50px"><td>Reg No</td><td><input type='text' name='reg_no' id='reg_no'>
                               </td></tr>
